  ...
  return (
    <div className='navbar'>
      ...
      <div className="navbar-right">
        {!showSearch ? <img src={assets.search_icon} alt="" onClick={() => setShowSearch(true)} style={{ cursor: "pointer" }} /> :
          <div className='navbar-search-input'>
            <input type="text" placeholder='Search...' value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} autoFocus />
            <img src={assets.cross_icon} onClick={() => { setShowSearch(false); setSearchQuery("") }} style={{ cursor: "pointer", width: "15px" }} />
          </div>
        }
